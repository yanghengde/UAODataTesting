...
{
    public enum DataScope { AtlPoc, AppU4DM, Engineering, Documentation, System, Administration}
    ...
    public class OData4
    {
        ...
        public static string SendCmd(string token, string cmdName, string cmdData, DataScope cmdScope)
        {
            ...
            switch (cmdScope)
            {
                case DataScope.AtlPoc:
                    startReq = "sit-svc/Application/StressTestingApp";
                    break;
